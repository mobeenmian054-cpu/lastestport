    ...
    <nav className="bg-gray-900 text-white text-xl fixed w-full z-50 shadow-md">
      ...
      {open && (
        <div className="md:hidden bg-gray-900 flex flex-col px-6 py-4 gap-4 text-white">
          ...
          <a href="#Project" className="hover:text-yellow-300" onClick={() => setOpen(false)}>Project</a>
          <a href="#Contact" className="hover:text-yellow-300" onClick={() => setOpen(false)}>Contact</a>
        </div>
      )}
    </nav>
  );
